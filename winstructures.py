...
PROCESS_ALL_ACCESS = (0x0080 | 0x0002 | 0x0040 | 0x0400 | 0x1000 | 0x0200 |
                      0x0100 | 0x0800 | 0x0001 | 0x0008 | 0x0010 | 0x0020 | 0x00100000)
...
TOKEN_ALL_ACCESS = (0x000F0000 | 0x0001 | 0x0002 | 0x0004 |
                    0x00000008 | 0x0010 | 0x00000020 | 0x0040 | 0x0080 | 0x0100)
TOKEN_PRIVS = (0x00000008 | (0x00020000 | 0x00000008) |
               0x0004 | 0x0010 | 0x0002 | 0x0001 | (131072 | 4))
...
NtSetInformationToken.argtypes = [
    HANDLE, TOKEN_INFORMATION_CLASS, LPVOID, ULONG]
...
RtlAllocateAndInitializeSid.argtypes = [POINTER(
    SID_IDENTIFIER_AUTHORITY), BYTE, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, LPVOID]
...
CreateProcessWithLogonW.argtypes = [LPCWSTR, LPCWSTR, LPCWSTR, DWORD, LPCWSTR,
                                    LPWSTR, DWORD, LPVOID, LPCWSTR, POINTER(STARTUPINFO), POINTER(PROCESS_INFORMATION)]
...
AdjustTokenPrivileges.argtypes = [
    HANDLE, BOOL, LPVOID, DWORD, LPVOID, POINTER(DWORD)]
...
UpdateProcThreadAttribute.argtypes = [POINTER(
    PROC_THREAD_ATTRIBUTE_LIST), DWORD, DWORD, PVOID, SIZE_T, PVOID, POINTER(SIZE_T)]

# https://docs.microsoft.com/en-us/windows/desktop/api/processthreadsapi/nf-processthreadsapi-createprocessw
CreateProcess = ctypes.windll.kernel32.CreateProcessW
CreateProcess.restype = BOOL
CreateProcess.argtypes = [LPCWSTR, LPWSTR, LPVOID, LPVOID, BOOL, DWORD,
                          LPVOID, LPCWSTR, POINTER(STARTUPINFOEX), POINTER(PROCESS_INFORMATION)]
...
DuplicateTokenEx.argtypes = [HANDLE, DWORD, LPVOID,
...
CreateProcessWithToken.argtypes = [HANDLE, DWORD, LPCWSTR, LPWSTR, DWORD,
                                   LPCWSTR, LPCWSTR, POINTER(STARTUPINFO), POINTER(PROCESS_INFORMATION)]
...
CreateService.argtypes = [SC_HANDLE, LPCTSTR, LPCTSTR, DWORD, DWORD,
...
CreateNamedPipe.argtypes = [LPCSTR, DWORD,
                            DWORD, DWORD, DWORD, DWORD, DWORD, LPVOID]
...
CreateProcessAsUser.argtypes = [HANDLE, LPCTSTR, LPTSTR, LPVOID, LPVOID, BOOL,
                                DWORD, LPVOID, LPCTSTR, POINTER(STARTUPINFO), POINTER(PROCESS_INFORMATION)]
